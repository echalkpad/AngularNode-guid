define(['calendar/calendar.module', 'fullcalendar'], function (module) {

    "use strict";

    module.registerDirective('gcDashboardCalendar', function (CalendarEvent, $log, $timeout) {
        return {
            restrict: 'E',
            replace: true,
            templateUrl: 'app/dashboard/directives/templates/gcDashboardCalendar.html',
            scope: {
                events: "=events"
            },
